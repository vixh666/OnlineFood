...
function CartSection(props) {
  ...
  <div className="modal fade" id="exampleModal" tabIndex={-1} aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <input type="password" className="form-control" id="exampleFormControlInput1" placeholder="Password" 
     onChange= {(e)=> setdetail({...userdetail, Password : e.target.value})  }
    />
    </div>
    ...
    <input type="password" className="form-control" id="exampleFormControlInput1" placeholder="Confirm Password" 
     onChange= {(e)=> setdetail({...userdetail, Confirm  : e.target.value})  }
    />
    </div>
        ...
        <div className="modal-footer">
          ...
          <button type="button" className="btn btn-primary" onClick={BuyHandler} >Login</button>
        </div>
      </div>
    </div>
  </div>
